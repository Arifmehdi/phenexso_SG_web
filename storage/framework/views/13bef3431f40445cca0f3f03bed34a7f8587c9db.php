<?php if($paginator->hasPages()): ?>
    <ul class="pagination">
        ...
        <?php else: ?>
            <li class="page-item">
                <a class="page-link page-link-prev" href="<?php echo e($paginator->previousPageUrl()); ?>" aria-label="Previous">
                    <i class="d-icon-arrow-left"></i>Prev
                </a>
            </li>
        <?php endif; ?>
        ...
        <?php if($paginator->hasMorePages()): ?>
            <li class="page-item">
                <a class="page-link page-link-next" href="<?php echo e($paginator->nextPageUrl()); ?>" aria-label="Next">
...
<?php endif; ?>
<?php /**PATH D:\laragon\laragon\www\phenexso_SG_web\resources\views/pagination/riode.blade.php ENDPATH**/ ?>