...
<?php $__env->startSection('title', (isset($category) ? $category->name_en : 'All Categories') . ' - '. ($ws->name ?? env('APP_NAME'))); ?>

<?php $__env->startSection('body_class', 'shop'); ?>

<?php $__env->startSection('meta'); ?>
    <meta name="description" content="Browse our wide selection of products in <?php echo e(isset($category) ? $category->name_en : 'All Categories'); ?> at <?php echo e($ws->name ?? 'Sungoods'); ?>.">
    <meta name="keywords" content="shop, ecommerce, products, <?php echo e(isset($category) ? $category->name_en : ''); ?>, <?php echo e($ws->meta_keywords ?? ''); ?>">
    <meta property="og:title" content="<?php echo e(isset($category) ? $category->name_en : 'All Categories'); ?> - <?php echo e($ws->name ?? env('APP_NAME')); ?>">
...
<div class="page-header" style="background-image: url('<?php echo e(asset('sungoods/images/shop/page-header-back.jpg')); ?>'); background-color: #3C63A4;">
    <h1 class="page-title"><?php echo e(isset($category) ? $category->name_en : 'All Categories'); ?></h1>
    <ul class="breadcrumb">
        ...
        <li class="delimiter">/</li>
        <li><?php echo e($category->name_en); ?></li>
        <?php endif; ?>
    </ul>
</div>
<!-- End PageHeader -->
                ...
                <div class="sidebar-content">
                    <div class="sticky-sidebar" data-sticky-options="{'top': 10}">
                        <div class="filter-actions mb-4">
                            ...
                            <a href="<?php echo e(route('productCategory', 'all')); ?>" class="filter-clean">Clean All</a>
                        </div>
                        <div class="widget widget-collapsible">
                            <h3 class="widget-title">All Categories</h3>
                            <ul class="widget-body filter-items search-ul">
                                <li class="<?php echo e($slug == 'all' || !$slug ? 'active' : ''); ?>"><a href="<?php echo e(route('productCategory', 'all')); ?>">All (<?php echo e(\App\Models\Product::where('active', 1)->count()); ?>)</a></li>
                                <?php $__currentLoopData = $allRootCategories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $rootCategory): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <li class="<?php echo e($slug == $rootCategory->slug ? 'active' : ''); ?>">
                                        ...
                                        <ul style="<?php echo e((isset($category) && ($category->id == $rootCategory->id || $category->parent_id == $rootCategory->id)) ? 'display: block' : ''); ?>">
                                            ...
                                            <li class="<?php echo e($slug == $child->slug ? 'active' : ''); ?>"><a href="<?php echo e(route('productCategory', $child->slug)); ?>"><?php echo e($child->name_en); ?> (<?php echo e($child->products()->count()); ?>)</a></li>
                                    ...
                                    <div class="product-details">
                                        ...
                                        <div class="ratings-container">
                                            <div class="ratings-full">
                                                <span class="ratings" style="width:<?php echo e(($topProduct->averageRating() / 5) * 100); ?>%"></span>
                                            </div>
                                        </div>
                                    </div>
                                </div>
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('website.layouts.sungoods', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\laragon\laragon\www\sungoods\resources\views/website/shop_category.blade.php ENDPATH**/ ?>