<div class="card card-widget" style="margin-bottom: 5px; max-height:600px;">
    <div class="card-header">
        ...
        <div class="card-tools">
            <a href="<?php echo e(route('medias.index')); ?>" class="btn btn-secondary mr-2"><i class="fa fa-image mr-2"></i>Upload Image</a>
        </div>
    </div>
    <div class="card-body datas-container" data-url="<?php echo e(route('medias.getMediasAjax')); ?>" data-last-page="<?php echo e($medias->lastPage()); ?>">
       <div class="p-3 datas-items" style="background-color: rgba(128, 128, 128, 0.37)">
        <?php echo $__env->make('admin.media.mediaAjax', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
       </div>
...
<script src="<?php echo e(asset('https://cdnjs.cloudflare.com/ajax/libs/jQuery-slimScroll/1.3.8/jquery.slimscroll.min.js')); ?>"></script>
...
<?php $__env->stopPush(); ?>
<?php /**PATH D:\laragon\laragon\www\sungoods\resources\views/admin/media/mediaContainer.blade.php ENDPATH**/ ?>