        ...
        <div class="col-md-11 mx-auto">
            ...
            <div class="card mb-2 shadow-lg">
                <div class="card-header- px-2 py-2 d-flex justify-content-between align-items-center">
                    ...
                    <a href="<?php echo e(route('admin.productCategoryCreate')); ?>" class="btn btn-outline-primary btn-xs py-1">
                ...
                <div class="card-body bg-light px-0 pb-0 pt-2">
                    <div class="col-sm-12">
                        <div class="table-responsive data-container">
                            <?php echo $__env->make('admin.productCategories.searchData', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                        </div>
...
<?php echo $__env->make('admin.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\laragon\laragon\www\sungoods\resources\views/admin/productCategories/productCategoriesAll.blade.php ENDPATH**/ ?>