            ...
            <div class="row">
                    ...
                    <div class="footer-widget footer-menu-widget clearfix">
                        ...
                        <div class="footer-menu">
                            <ul>
                                ...
                                <li><a href="<?php echo e(route('shop')); ?>">Our Products</a></li>
                ...
                <div class="col-xl-3 col-md-6 col-sm-12 col-12">
                    <div class="footer-widget footer-newsletter-widget">
                        ...
                        <div class="mt-20"><img src="<?php echo e(asset('frontend/img/icons/payment-4.png')); ?>" alt="Payment"></div>
        ...
        <div class="container-fluid">
            <div class="row">
                <div class="col-md-6 col-12">
                    <p>© <?php echo e(date('Y')); ?> Sungoods Bangladesh – All Rights Reserved.</p>
                </div>
                                ...
                                <div class="row">
                                    <div class="col-12">
                                        ...
                                        <div class="modal-product-img">
                                            ...
                                            <!-- <img src="<?php echo e(asset('frontend/img/product/1.png')); ?>" alt="#"> -->
                                        </div>
                                         ...
                                         <div class="additional-info d-none---">
                                            ...
                                            <div class="payment-method">
                                                <img src="<?php echo e(asset('frontend/img/icons/payment.png')); ?>" alt="#">
                                            </div>
                                         </div>
                                    </div>
                                </div>
                         ...
                         <div class="ltn__quick-view-modal-inner">
                             <div class="modal-product-item">
                                <div class="row">
                                    <div class="col-12">
                                        <div class="modal-product-img">
                                            <img src="<?php echo e(asset('frontend/img/product/7.png')); ?>" alt="#">
                                        </div>
                                         <div class="modal-product-info">
                                            <h5><a href="product-details.html">Vegetables Juices</a></h5>
                                            <p class="added-cart"><i class="fa fa-check-circle"></i>  Successfully added to your Wishlist</p>
                                            <div class="btn-wrapper">
                                                <a href="<?php echo e(route('wishlist.index')); ?>" class="theme-btn-1 btn btn-effect-1">View Wishlist</a>
                                            </div>
                                         </div>
                                         <!-- additional-info -->
                                         <div class="additional-info d-none">
...
<?php /**PATH D:\laragon\laragon\www\phenexso_SG_web\resources\views/website/layouts/footer.blade.php ENDPATH**/ ?>