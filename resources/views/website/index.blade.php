            ...
            <div class="col-lg-6 col-md-6 col-sm-12 order-2 order-lg-1">
                <div class="content-box pe-lg-4">
                    ...
                    <a href="#" class="btn-primary"
                        style="display: inline-block; background: #084E8A; color: #fff; padding: 12px 28px; border-radius: 8px; font-weight: 600; text-decoration: none; transition: all 0.3s ease; border: none;">
                        Learn More
            ...
            <div class="col-lg-7 col-md-12">
                <div class="call-to-action-inner call-to-action-inner-4 text-center---">
                    ...
                    <div class="section-title-area ltn__section-title-2 text-center---">
                        <h6  style="color: #084E8A">Todays Hot Deals</h6>
...
<div class="col-lg-6 align-self-center">
    <div class="about-us-info-wrap">
        <div class="section-title-area ltn__section-title-2">
            <h6 class="section-subtitle " style="background: #084E8A">Know More About Shop</h6>
...
<section class="how-it-works-section" style="padding: 80px 0; background: #f8f9fb;">
    <div class="container">
            ...
            <div class="col-lg-3 col-md-6 col-sm-12 text-center mb-5">
                <div class="work-card"
                    ...
                    <div class="position-relative mb-4">
                        ...
                        <div class="small-circle" style="width: 40px; height: 40px; border-radius: 50%; background: #084E8A; color: #fff; font-weight: 600;
        ...
        <div class="small-circle"
            style="width: 40px; height: 40px; border-radius: 50%; background: #084E8A; color: #fff; font-weight: 600; display: flex; align-items: center; justify-content: center; position: absolute; left: 50%; bottom: -20px; transform: translateX(-50%); font-size: 15px;">
            02
        </div>
    </div>
...
<div class="ltn__testimonial-area section-bg-1 pt-290 pb-70">
    <div class="container-fluid">
        <div class="row">
            <div class="col-lg-12">
                <div class="section-title-area ltn__section-title-2 text-center">
                    <h6 class="section-subtitle " style="color: #084E8A">// Testimonials</h6>
    ...
    <div class="container">
        <div class="row">
            <div class="col-lg-12">
                <div class="call-to-action-inner call-to-action-inner-4 text-center">
                    <div class="section-title-area ltn__section-title-2">
                        <h6 class="section-subtitle " style="font-size: 14px; color: white;">
